...
function Patients() {
    ...
    const [searchResults, setSearchResults] = useState([]); // Initialized as an empty array instead of an empty string

    // Function for handling search behavior
    ...
    // Retrieve all patients on initial page load
    useEffect(() => {
            ...
            <List
                ...
                renderItem={(item) => (
                    <List.Item
                        ...
                        onClick={() => navigate(`/patient/${item.medical_ref_number}`)} // ✅ Added navigation on click
                        style={{ cursor: "pointer" }} // ✅ Added cursor pointer to indicate clickability
                    >
