    ...
    return (
        <div className={styles.sideMenu}>
            <div className={styles.buttonContainer2}>
                <Button shape={"circle"} className={styles.button} icon={<EyeOutlined style={{color: "#004AAD"}}/>}
            ...
            <br/>
            <div className={styles.buttonContainer2}>
                <Button shape={"circle"} className={styles.button} icon={<HomeOutlined style={{color: "#004AAD"}}/>}
            ...
            <div className={styles.buttonContainer2}>
                <Button shape={"circle"} className={styles.button} icon={<UserOutlined style={{color: "#004AAD"}}/>}
